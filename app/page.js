    ...
    <main>
      ...
      <section className="sticky top-0 w-full h-screen overflow-hidden bg-black" style={{ zIndex: 0 }}>
        ...
        <div ref={textRef} className="absolute inset-0 z-30 flex flex-col justify-end px-5 pb-14 md:px-[80px] md:pb-20 will-change-transform">
          ...
          <h1
            ...
            style={{ fontSize: 'clamp(56px, 11vw, 148px)', letterSpacing: '0.04em', animationDelay: '0.8s' }}
          >
            Equestrian
          ...
          {/* CTAs — horizontal, editorial */}
          <div className="flex flex-col sm:flex-row items-start gap-4 mt-8 opacity-0 animate-fade-up" style={{ animationDelay: '1.1s' }}>
            <a href="#"
              className="btn-shimmer inline-flex items-center gap-5 font-[var(--font-cinzel)] text-[10px] tracking-[0.4em] text-champagne uppercase bg-burgundy border border-burgundy/80 px-8 py-3.5 transition-all duration-300 hover:bg-burgundy/80 active:scale-[0.97]">
              {tx.hero.cta1}
              <span className="w-4 h-px bg-current" />
            </a>
            <a href="#about"
              className="inline-flex items-center gap-5 font-[var(--font-cinzel)] text-[10px] tracking-[0.4em] text-champagne/60 uppercase border border-gold/30 px-8 py-3.5 transition-all duration-300 hover:text-champagne hover:border-gold/60 active:scale-[0.97]">
              {tx.hero.cta2}
            </a>
          </div>
        </div>
        ...
        <div className="absolute bottom-12 md:bottom-[72px] right-8 md:right-[72px] z-30 flex flex-col items-end gap-3 opacity-0 animate-fade-in" style={{ animationDelay: '1.6s' }}>
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-champagne/45 hover:text-gold transition-colors duration-200" aria-label="Instagram">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/>
              </svg>
            </a>
            <a href="#" className="text-champagne/45 hover:text-gold transition-colors duration-200" aria-label="Facebook">
      ...
      <section id="about" className="relative bg-champagne px-5 pt-16 pb-14 md:px-[80px] md:pt-24 md:pb-20 overflow-hidden"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 md:gap-20 items-start">
          ...
          <div>
            <blockquote
              className="font-[var(--font-cormorant)] italic font-light text-burgundy leading-[1.2] mb-10"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div>
                <h2 className="font-[var(--font-cinzel)] font-semibold text-burgundy uppercase tracking-[0.1em] leading-[1.2] mb-0"
              ...
              <p className="font-[var(--font-jost)] font-light text-[14px] leading-[1.9] text-burgundy/60 self-end">
      ...
      {/* ── STATS — dark band ── */}
      <section className="bg-burgundy py-14 md:py-18 px-5 md:px-[80px]">
        <div className="grid grid-cols-3 divide-x divide-gold/15">
          {[
            { num: '10+', label: t[lang].aboutMe?.education ? 'Years Experience' : 'Years' },
